        ...
        <>
            <div className="ms-5 container-fluid d-flex flex-wrap" >
                <div className="container-fluid d-inline-flex rounded-2" style={{"margin-left":"20vw", "margin-top":"2vh"}}>
                    <img src="https://picsum.photos/200/300" className="card-img-top border-end border-danger" alt="..." style={{"height":"40vh", "width":"30vw"}}/>
                ...
                <ul className="d-flex flex-wrap" style={{"margin-left":"20vw", "margin-top":"2vh", "margin-right":"18vw","background-color":"rgb(2, 1, 1)"}}>
                            { store.itemDetails ? Object.keys(store.itemDetails).map(key => {
                                 return (
                                    <li
                                            ...
                                            <div className="container" style={{"border-right":"solid", "border-collapse": "separate", "border-spacing":"60px" }}>
